...
def main():
    ...
    left = [
        ...
        Spacer(1, 3 * mm),
        P(
            "Profil fondé sur la rigueur, l’écoute et l’adaptation aux contextes cliniques variés, avec un parcours construit entre cabinet, remplacements, expérience hospitalière et santé au travail.",
            9.4,
            13,
        ),
    ]
