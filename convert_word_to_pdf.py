...
def main():
    ...
    text_block = [
        ...
        Spacer(1, 2 * mm),
        Paragraph("Profil clinique fondé sur la rigueur, le sens de l’écoute,<br/>l’adaptation aux contextes variés et une solide expérience de terrain.", style("body", 9.8, colors.HexColor("#33404d"), leading=13)),
    ]
